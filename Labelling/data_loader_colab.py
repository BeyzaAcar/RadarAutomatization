...
# Drive'daki ana veri klasörünüz
root_dir = "/content/drive/MyDrive/Labelled_Dataset"  # Tüm kişilerin olduğu ana klasör
...
# CSV dosyasını Drive'da kaydetme
output_csv_path = "/content/drive/MyDrive/dataset.csv"  # CSV dosyasının Drive'da kaydedileceği yer
df = pd.DataFrame(data, columns=["TrialPath", "Label", "Split"])
df.to_csv(output_csv_path, index=False, encoding='utf-8', sep=';')  # UTF-8 ile doğru ayrıştırma
