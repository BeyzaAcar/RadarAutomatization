...
def main():
    ...
    for tekrar_index in range(1, args.tekrar_ + 1):
        ...
        bin_output_path = os.path.expanduser(f"~/RADAR_PROJECT/Dataset/BinData/{args.denek_}_deney{args.deney_no_}_tekrar{tekrar_index}_timestamp{timestamp}.bin")
        camera_output_path = os.path.expanduser(f"~/RADAR_PROJECT/Dataset/CameraData/{args.denek_}_deney{args.deney_no_}_tekrar{tekrar_index}_timestamp{timestamp}.avi")
